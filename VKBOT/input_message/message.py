...
from VKBOT.input_message.video import *  # Недоделано (проблемы со скачиванием)
from VKBOT.input_message.audio import *
from VKBOT.input_message.document import *
from VKBOT.input_message.geoposition import *
